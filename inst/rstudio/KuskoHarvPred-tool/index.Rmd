...
:::{.subtext}
`r paste0('Daily Drift Harvest Based on ', min(KuskoHarvPred:::fit_data$year), '-', max(KuskoHarvPred:::fit_data$year), ' In-Season Monitoring')`
:::
...
div(
  ...
  renderPlot(expr = {
    ...
    vars_biplot(
      ...
      x_axis_type = KuskoHarvPred:::choose_axis_type(input$scatterplot_xvar),
      y_axis_type = KuskoHarvPred:::choose_axis_type(input$scatterplot_yvar),
...
div(
  ...
  renderPlot(expr = {
    ...
    axis_type = KuskoHarvPred:::choose_axis_type(input$obs_v_pred_plot_response)

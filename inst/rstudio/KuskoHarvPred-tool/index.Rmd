...
author: "_v0.1.0.9990; DRAFT FOR USE IN 2023_"
  ...
  div(
    ...
    fillRow(
      ...
      column(
        ...
        wellPanel(
          selectizeInput("data_kable_years", "Years", choices = yrs, selected = yrs, multiple = TRUE,
...
observeEvent(input$filter_periods_select_all, {
  updateSelectizeInput(inputId = "data_kable_years", selected = yrs)
